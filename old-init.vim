...
call plug#begin()
  ...
  " File Search
  " In order to improve the search you must install ripgrep -> https://github.com/BurntSushi/ripgrep
  " Add this in zshrc -> export FZF_DEFAULT_COMMAND='rg --files --follow --no-ignore-vcs --hidden -g "!{node_modules/*,.git/*}"'
